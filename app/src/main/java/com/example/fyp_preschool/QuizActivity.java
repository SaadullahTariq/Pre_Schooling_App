...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ImageView quiz_card_abc, quiz_card_animal, quiz_card_color, quiz_card_bodypart, quiz_card_shapes, quiz_card_urdu;
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz);

        quiz_card_abc = findViewById(R.id.quiz_card_abc);
        quiz_card_animal = findViewById(R.id.quiz_card_animal);
        quiz_card_color = findViewById(R.id.quiz_card_color);
